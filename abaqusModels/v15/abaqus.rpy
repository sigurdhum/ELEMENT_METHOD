...
s.CircleByCenterPerimeter(center=(-134.05, 95.75), point1=(-124.475, 86.175))
s.undo()
s.CircleByCenterPerimeter(center=(-114.9, 76.6), point1=(-119.6875, 90.9625))
s.undo()
s.undo()
s.CircleByCenterPerimeter(center=(-114.9, 76.6), point1=(-114.9, 86.175))
s.CircleByCenterPerimeter(center=(114.9, 76.6), point1=(114.9, 86.175))
session.viewports['Viewport: 1'].view.setValues(nearPlane=715.112, 
    farPlane=816.675, cameraPosition=(177.499, 119.387, 773.643), 
    cameraTarget=(177.499, 119.387, 7.75))
session.viewports['Viewport: 1'].view.setValues(session.views['Front'])
s.VerticalDimension(vertex1=v[0], vertex2=v[1], textPoint=(-90.5833404541016, 
    77.1759399414063), value=9.575)
s.VerticalDimension(vertex1=v[2], vertex2=v[3], textPoint=(79.2230560302734, 
    78.9332336425781), value=9.575)
s.undo()
s.undo()
s.VerticalDimension(vertex1=v[0], vertex2=v[1], textPoint=(-81.9136627197266, 
    83.9123291015625), value=10.0)
s.ObliqueDimension(vertex1=v[2], vertex2=v[3], textPoint=(83.7074005126953, 
    63.1173156738281), value=10.0)
session.viewports['Viewport: 1'].view.setValues(nearPlane=722.295, 
    farPlane=810.747, width=475.484, height=209.441, cameraPosition=(134.249, 
    119.695, 774.271), cameraTarget=(134.249, 119.695, 7.75))
s.Spot(point=(-114.9, 86.175))
s.CoincidentConstraint(entity1=v[4], entity2=g[2], addUndoState=False)
s.Spot(point=(-114.9, 76.175))
s.delete(objectList=(g[2], ))
s.delete(objectList=(v[5], ))
s.delete(objectList=(v[4], ))
s.CircleByCenterPerimeter(center=(-114.9, 76.6), point1=(-114.9, 90.9625))
s.VerticalDimension(vertex1=v[6], vertex2=v[7], textPoint=(-78.6634033203125, 
    86.6124328613281), value=10.0)
session.viewports['Viewport: 1'].view.setValues(nearPlane=722.295, 
    farPlane=810.747, width=420.138, height=185.062, cameraPosition=(123.152, 
    127.727, 774.271), cameraTarget=(123.152, 127.727, 7.75))
s.undo()
s.VerticalDimension(vertex1=v[6], vertex2=v[7], textPoint=(-86.9817321777344, 
    83.9877990722656), value=10.0)
s.undo()
s.undo()
s.CircleByCenterPerimeter(center=(-114.9, 76.6), point1=(-110.1125, 90.9625))
s.undo()
s.CircleByCenterPerimeter(center=(-114.9, 76.6), point1=(-110.1125, 90.9625))
s.ObliqueDimension(vertex1=v[6], vertex2=v[7], textPoint=(-98.1773345947266, 
    62.2843841552734), value=10.0)
session.viewports['Viewport: 1'].view.setValues(nearPlane=691.79, 
    farPlane=830.067, cameraPosition=(241.43, 106.387, 764.789), 
    cameraUpVector=(-0.109393, 0.992976, 0.0450826), cameraTarget=(123.152, 
    127.727, 7.75))
session.viewports['Viewport: 1'].view.setValues(session.views['Front'])
session.viewports['Viewport: 1'].view.setValues(nearPlane=715.739, 
    farPlane=817.303, cameraPosition=(171.229, 73.989, 774.271), cameraTarget=(
    171.229, 73.989, 7.75))
s.CircleByCenterPerimeter(center=(-114.9, -76.6), point1=(-114.9, -90.9625))
s.VerticalDimension(vertex1=v[8], vertex2=v[9], textPoint=(-78.9428527832031, 
    -84.4981475830078), value=10.0)
s.undo()
s.undo()
s.CircleByCenterPerimeter(center=(-114.9, -76.6), point1=(-95.75, -86.175))
s.ObliqueDimension(vertex1=v[8], vertex2=v[9], textPoint=(-83.7261322021484, 
    -58.7240310668945), value=10.0)
s.CircleByCenterPerimeter(center=(114.9, -76.6), point1=(95.75, -57.45))
s.ObliqueDimension(vertex1=v[10], vertex2=v[11], textPoint=(69.9367248535156, 
    -87.1341339111328), value=10.0)
mdb.save()
#: The model database has been saved to "Y:\mb_sss_points.cae".
mdb.save()
#: The model database has been saved to "Y:\mb_sss_points.cae".
...
s.unsetPrimaryObject()
del mdb.models['Model-1'].sketches['__profile__']
session.viewports['Viewport: 1'].view.setValues(nearPlane=708.81, 
    farPlane=824.231, width=577.862, height=245.549, viewOffsetX=19.1949, 
    viewOffsetY=-4.42027)
a1 = mdb.models['Model-1'].rootAssembly
a1.regenerate()
a = mdb.models['Model-1'].rootAssembly
...
session.viewports['Viewport: 1'].assemblyDisplay.setValues(loads=ON, bcs=ON, 
    predefinedFields=ON, connectors=ON, adaptiveMeshConstraints=OFF)
del mdb.models['Model-1'].boundaryConditions['ss_static']
a = mdb.models['Model-1'].rootAssembly
f1 = a.instances['Part-1-1'].faces
faces1 = f1.getSequenceFromMask(mask=('[#17 ]', ), )
region = a.Set(faces=faces1, name='Set-6')
mdb.models['Model-1'].DisplacementBC(name='feet_BC', createStepName='turbo', 
    region=region, u1=0.0, u2=0.0, u3=0.0, ur1=UNSET, ur2=UNSET, ur3=UNSET, 
    amplitude=UNSET, fixed=OFF, distributionType=UNIFORM, fieldName='', 
    localCsys=None)
session.viewports['Viewport: 1'].view.setValues(nearPlane=707.846, 
    farPlane=825.195, width=584.188, height=248.237, viewOffsetX=-4.91627, 
    viewOffsetY=-4.51815)
session.viewports['Viewport: 1'].view.setValues(nearPlane=539.149, 
    farPlane=1007.47, width=444.961, height=189.076, cameraPosition=(-511.54, 
    -238.988, -165.062), cameraUpVector=(-0.499718, 0.672725, 0.54564), 
    cameraTarget=(148.998, 105.872, 14.7028), viewOffsetX=-3.7446, 
    viewOffsetY=-3.44137)
session.viewports['Viewport: 1'].view.setValues(nearPlane=571.841, 
    farPlane=974.193, width=471.941, height=200.541, cameraPosition=(-371.783, 
    -274.177, -405.418), cameraUpVector=(-0.730676, 0.53085, 0.429315), 
    cameraTarget=(148.219, 104.329, 11.5786), viewOffsetX=-3.97166, 
    viewOffsetY=-3.65004)
session.viewports['Viewport: 1'].view.setValues(nearPlane=546.959, 
    farPlane=1001.22, width=451.406, height=191.815, cameraPosition=(-386.6, 
    -439.466, -36.7331), cameraUpVector=(-0.623168, 0.563269, 0.542577), 
    cameraTarget=(150.874, 104.512, 15.8498), viewOffsetX=-3.79885, 
    viewOffsetY=-3.49122)
session.viewports['Viewport: 1'].view.setValues(nearPlane=548.264, 
    farPlane=999.662, width=452.483, height=192.273, cameraPosition=(-398.859, 
    -421.408, -80.9068), cameraUpVector=(-0.631108, 0.561191, 0.535507), 
    cameraTarget=(150.452, 104.466, 15.3724), viewOffsetX=-3.80792, 
    viewOffsetY=-3.49955)
session.viewports['Viewport: 1'].view.setValues(nearPlane=551.831, 
    farPlane=995.359, width=455.427, height=193.524, cameraPosition=(-417.537, 
    -359.667, -211.527), cameraUpVector=(-0.657221, 0.555198, 0.509722), 
    cameraTarget=(149.338, 104.46, 13.8488), viewOffsetX=-3.83269, 
    viewOffsetY=-3.52232)
session.viewports['Viewport: 1'].view.setValues(nearPlane=608.861, 
    farPlane=936.132, width=502.494, height=213.524, cameraPosition=(-320.837, 
    -68.1382, -572.948), cameraUpVector=(-0.720239, 0.557233, 0.413216), 
    cameraTarget=(147.389, 105.919, 8.45029), viewOffsetX=-4.22879, 
    viewOffsetY=-3.88634)
session.viewports['Viewport: 1'].view.setValues(nearPlane=599.56, 
    farPlane=944.786, width=494.818, height=210.262, cameraPosition=(-473.076, 
    103.955, -439.64), cameraUpVector=(-0.453984, 0.639868, 0.620054), 
    cameraTarget=(147.281, 107.815, 10.5796), viewOffsetX=-4.16419, 
    viewOffsetY=-3.82697)
session.viewports['Viewport: 1'].view.setValues(nearPlane=550.13, 
    farPlane=995.661, width=454.024, height=192.927, cameraPosition=(-580.459, 
    -122.164, -13.1178), cameraUpVector=(-0.240184, 0.681177, 0.691599), 
    cameraTarget=(150.492, 106.895, 15.1224), viewOffsetX=-3.82088, 
    viewOffsetY=-3.51146)
session.viewports['Viewport: 1'].view.setValues(nearPlane=556.458, 
    farPlane=989.318, width=459.246, height=195.146, cameraPosition=(-581.556, 
    -92.9967, 115.153), cameraUpVector=(-0.0811512, 0.665449, 0.742019), 
    cameraTarget=(151.782, 106.893, 16.0887), viewOffsetX=-3.86483, 
    viewOffsetY=-3.55185)
session.viewports['Viewport: 1'].view.setValues(nearPlane=557.745, 
    farPlane=988.737, width=460.308, height=195.597, cameraPosition=(-488.063, 
    -199.269, 302.268), cameraUpVector=(-0.0142522, 0.697488, 0.716455), 
    cameraTarget=(154.295, 106.73, 17.1452), viewOffsetX=-3.87377, 
    viewOffsetY=-3.56006)
session.viewports['Viewport: 1'].view.setValues(nearPlane=612.956, 
    farPlane=934.817, width=505.874, height=214.959, cameraPosition=(-120.092, 
    -310.822, 595.092), cameraUpVector=(0.0932042, 0.784263, 0.613387), 
    cameraTarget=(160.045, 107.786, 17.2986), viewOffsetX=-4.25724, 
    viewOffsetY=-3.91247)
session.viewports['Viewport: 1'].view.setValues(nearPlane=609.238, 
    farPlane=938.536, width=502.806, height=213.655, cameraPosition=(-120.582, 
    -310.202, 595.304), cameraUpVector=(-0.0110002, 0.812281, 0.583163), 
    cameraTarget=(159.555, 108.406, 17.5102), viewOffsetX=-4.23142, 
    viewOffsetY=-3.88874)
session.viewports['Viewport: 1'].view.setValues(nearPlane=609.489, 
    farPlane=938.285, width=503.013, height=213.743, cameraPosition=(-121.064, 
    -309.687, 595.443), cameraUpVector=(-0.1025, 0.82849, 0.550544), 
    cameraTarget=(159.073, 108.921, 17.6495), viewOffsetX=-4.23316, 
    viewOffsetY=-3.89034)
session.viewports['Viewport: 1'].view.setValues(nearPlane=609.472, 
    farPlane=938.302, width=502.999, height=213.737, viewOffsetX=-4.23304, 
    viewOffsetY=-3.89023)
session.viewports['Viewport: 1'].view.setValues(nearPlane=617.31, 
    farPlane=932.067, width=509.468, height=216.486, cameraPosition=(304.353, 
    -465.995, 503.549), cameraUpVector=(0.0409155, 0.65344, 0.755872), 
    cameraTarget=(164.128, 107.834, 15.07), viewOffsetX=-4.28748, 
    viewOffsetY=-3.94026)
del mdb.models['Model-1'].loads['s_ss_uniformed']
a = mdb.models['Model-1'].rootAssembly
s1 = a.instances['Part-1-1'].faces
side1Faces1 = s1.getSequenceFromMask(mask=('[#1f ]', ), )
region = a.Surface(side1Faces=side1Faces1, name='Surf-4')
mdb.models['Model-1'].Pressure(name='minus_feets', createStepName='turbo', 
    region=region, distributionType=UNIFORM, field='', magnitude=2.0, 
    amplitude=UNSET)
mdb.models['Model-1'].loads.changeKey(fromName='minus_feets', 
    toName='pressure')
session.viewports['Viewport: 1'].view.setValues(nearPlane=616.818, 
    farPlane=932.559, width=509.062, height=216.314, cameraPosition=(304.304, 
    -465.964, 503.599), cameraUpVector=(0.0306602, 0.652233, 0.757398), 
    cameraTarget=(164.079, 107.865, 15.12), viewOffsetX=-4.28406, 
    viewOffsetY=-3.93712)
session.viewports['Viewport: 1'].assemblyDisplay.setValues(mesh=ON, loads=OFF, 
    bcs=OFF, predefinedFields=OFF, connectors=OFF)
session.viewports['Viewport: 1'].assemblyDisplay.meshOptions.setValues(
...
session.viewports['Viewport: 1'].assemblyDisplay.meshOptions.setValues(
    meshTechnique=OFF)
mdb.Job(name='feets', model='Model-1', description='', type=ANALYSIS, 
    atTime=None, waitMinutes=0, waitHours=0, queue=None, memory=90, 
    memoryUnits=PERCENTAGE, getMemoryFromAnalysis=True, 
    explicitPrecision=SINGLE, nodalOutputPrecision=SINGLE, echoPrint=OFF, 
    modelPrint=OFF, contactPrint=OFF, historyPrint=OFF, userSubroutine='', 
    scratch='', resultsFormat=ODB, numThreadsPerMpiProcess=1, 
    multiprocessingMode=DEFAULT, numCpus=1, numGPUs=0)
session.viewports['Viewport: 1'].view.setValues(nearPlane=592.496, 
    farPlane=956.881, width=853.391, height=375.902, viewOffsetX=167.052, 
    viewOffsetY=-60.0962)
session.viewports['Viewport: 1'].view.setValues(nearPlane=589.159, 
    farPlane=960.218, width=848.585, height=373.785, viewOffsetX=37.814, 
    viewOffsetY=62.7946)
session.viewports['Viewport: 1'].view.setValues(nearPlane=589.107, 
    farPlane=960.27, width=848.51, height=373.752, viewOffsetX=60.3927, 
    viewOffsetY=9.53057)
session.viewports['Viewport: 1'].view.setValues(nearPlane=619.298, 
    farPlane=930.078, width=451.616, height=198.928, viewOffsetX=25.0442, 
    viewOffsetY=-2.35411)
session.viewports['Viewport: 1'].assemblyDisplay.setValues(
    adaptiveMeshConstraints=ON)
mdb.models['Model-1'].historyOutputRequests['displays_his'].suppress()
mdb.models['Model-1'].historyOutputRequests['history'].suppress()
mdb.models['Model-1'].historyOutputRequests['H-Output-2'].suppress()
mdb.models['Model-1'].historyOutputRequests['history'].resume()
mdb.models['Model-1'].historyOutputRequests['history'].suppress()
mdb.models['Model-1'].historyOutputRequests['H-Output-2'].resume()
mdb.models['Model-1'].historyOutputRequests['H-Output-2'].suppress()
mdb.models['Model-1'].historyOutputRequests['H-Output-2'].resume()
mdb.models['Model-1'].historyOutputRequests['history'].resume()
mdb.models['Model-1'].historyOutputRequests['history'].suppress()
...
session.viewports['Viewport: 1'].assemblyDisplay.setValues(
    adaptiveMeshConstraints=OFF)
mdb.jobs['feets'].submit(consistencyChecking=OFF)
#: The job input file "feets.inp" has been submitted for analysis.
#: Job feets: Analysis Input File Processor completed successfully.
#: Job feets: Abaqus/Standard completed successfully.
#: Job feets completed successfully. 
o3 = session.openOdb(name='Y:/feets.odb')
#: Model: Y:/feets.odb
#: Number of Assemblies:         1
#: Number of Assembly instances: 0
#: Number of Part instances:     1
...
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='U', outputPosition=NODAL, refinement=(COMPONENT, 'U3'), )
session.viewports['Viewport: 1'].view.setValues(nearPlane=980.331, 
    farPlane=1451.69, width=935.863, height=412.229, cameraPosition=(-519.452, 
    362.999, 945.075), cameraUpVector=(0.110176, 0.802483, -0.586415), 
    cameraTarget=(134.679, 83.8873, 25.0008))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1079.97, 
    farPlane=1382.83, width=1030.99, height=454.129, cameraPosition=(56.5394, 
    121.359, 1193.14), cameraUpVector=(-0.205683, 0.897314, -0.390541), 
    cameraTarget=(159.838, 73.3326, 35.836))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1018.28, 
    farPlane=1432.9, width=972.097, height=428.188, cameraPosition=(488.588, 
    398.459, 1109.89), cameraUpVector=(-0.337977, 0.801142, -0.493907), 
    cameraTarget=(183.873, 88.7477, 31.2047))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1076.33, 
    farPlane=1409.02, width=1027.51, height=452.597, cameraPosition=(135.19, 
    -236.9, 1158.63), cameraUpVector=(-0.456948, 0.880291, -0.127621), 
    cameraTarget=(165.796, 56.248, 33.6976))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1041.3, 
    farPlane=1409.87, width=994.071, height=437.868, cameraPosition=(280.282, 
    437.131, 1140.36), cameraUpVector=(-0.305392, 0.772752, -0.556408), 
    cameraTarget=(175.11, 99.5161, 32.5249))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1007.51, 
    farPlane=1501.82, width=961.816, height=423.661, cameraPosition=(602.918, 
    -728.779, 783.921), cameraUpVector=(-0.646577, 0.612975, 0.454091), 
    cameraTarget=(191.611, 39.8862, 14.295))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1055.19, 
    farPlane=1466.85, width=1007.33, height=443.709, cameraPosition=(199.693, 
    -1099.38, 317.897), cameraUpVector=(-0.0365014, 0.591808, 0.805252), 
    cameraTarget=(162.12, 12.7819, -19.7883))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1062.17, 
    farPlane=1464.75, width=1013.99, height=446.643, cameraPosition=(180.138, 
    -1145.64, 98.5941), cameraUpVector=(0.0162693, 0.44118, 0.897271), 
    cameraTarget=(160.598, 9.1824, -36.8515))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1095.16, 
    farPlane=1431.75, width=639.901, height=281.864, viewOffsetX=73.0167, 
    viewOffsetY=14.8569)
session.viewports['Viewport: 1'].view.setValues(nearPlane=1089.45, 
    farPlane=1448.21, width=636.569, height=280.396, cameraPosition=(259.273, 
    -1150.55, 60.5963), cameraUpVector=(-0.0319105, 0.413819, 0.9098), 
    cameraTarget=(167.567, 4.202, -41.7871), viewOffsetX=72.6364, 
    viewOffsetY=14.7796)
session.viewports['Viewport: 1'].view.setValues(nearPlane=1030.71, 
    farPlane=1506.96, width=1437.99, height=633.407, viewOffsetX=261.265, 
    viewOffsetY=31.2619)
session.viewports['Viewport: 1'].view.setValues(nearPlane=1024.32, 
    farPlane=1513.35, width=1429.09, height=629.483, viewOffsetX=259.647, 
    viewOffsetY=31.0682)
session.viewports['Viewport: 1'].view.setValues(nearPlane=1024.97, 
    farPlane=1512.7, width=1429.99, height=629.882, viewOffsetX=50.0895, 
    viewOffsetY=-37.2223)
session.viewports['Viewport: 1'].view.setValues(nearPlane=1075.94, 
    farPlane=1461.73, width=760.002, height=334.765, viewOffsetX=11.0353, 
    viewOffsetY=-8.40537)
mdb.save()
#: The model database has been saved to "Y:\mb_sss_points.cae".
session.viewports['Viewport: 1'].view.setValues(nearPlane=1095.04, 
    farPlane=1442.63, width=535.794, height=236.006, viewOffsetX=1.04748, 
    viewOffsetY=-2.68066)
session.viewports['Viewport: 1'].view.setValues(nearPlane=1051.34, 
    farPlane=1473.22, width=514.412, height=226.588, cameraPosition=(556.427, 
    -940.633, 538.22), cameraUpVector=(-0.659013, 0.478818, 0.58003), 
    cameraTarget=(190.999, 21.6013, -2.99459), viewOffsetX=1.00568, 
    viewOffsetY=-2.57368)
session.viewports['Viewport: 1'].view.setValues(nearPlane=1142.23, 
    farPlane=1349.69, width=558.883, height=246.176, cameraPosition=(133.238, 
    89.6852, 1210.72), cameraUpVector=(-0.157346, 0.932757, -0.324356), 
    cameraTarget=(158.593, 105.289, 48.1959), viewOffsetX=1.09262, 
    viewOffsetY=-2.79617)
p = mdb.models['Model-1'].parts['Part-1']
session.viewports['Viewport: 1'].setValues(displayedObject=p)
p = mdb.models['Model-1'].parts['Part-1']
n = p.nodes
nodes = n.getSequenceFromMask(mask=(
    '[#0:23 #3000 #3c000 #22d40000 #afc001 #7a40af82 #24f40015', 
    ' #32 #0:2 #7f020000 ]', ), )
p.Set(nodes=nodes, name='Set-3')
#: The set 'Set-3' has been created (56 nodes).
mdb.models['Model-1'].parts['Part-1'].sets.changeKey(fromName='Set-3', 
    toName='display_with_feet')
a1 = mdb.models['Model-1'].rootAssembly
a1.regenerate()
a = mdb.models['Model-1'].rootAssembly
session.viewports['Viewport: 1'].setValues(displayedObject=a)
...
session.viewports['Viewport: 1'].assemblyDisplay.setValues(loads=OFF, bcs=OFF, 
    predefinedFields=OFF, connectors=OFF, adaptiveMeshConstraints=ON)
regionDef=mdb.models['Model-1'].rootAssembly.allInstances['Part-1-1'].sets['display_with_feet']
mdb.models['Model-1'].HistoryOutputRequest(name='displaysment_feet', 
    createStepName='turbo', variables=('U3', ), region=regionDef, 
    sectionPoints=DEFAULT, rebar=EXCLUDE)
regionDef=mdb.models['Model-1'].rootAssembly.sets['Set-6']
mdb.models['Model-1'].HistoryOutputRequest(name='reaction_force', 
    createStepName='turbo', variables=('RF3', ), region=regionDef, 
    sectionPoints=DEFAULT, rebar=EXCLUDE)
mdb.save()
#: The model database has been saved to "Y:\mb_sss_points.cae".
...
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='U', outputPosition=NODAL, refinement=(COMPONENT, 'U3'), )
odb = session.odbs['Y:/feets.odb']
session.XYDataFromHistory(name='max_displaycment_feet', odb=odb, 
    outputVariableName='Spatial displacement: U3 at Node 919 in NSET DISPLAY_WITH_FEET', 
    steps=('turbo', ), __linkedVpName__='Viewport: 1')
odb = session.odbs['Y:/feets.odb']
xy0 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Spatial displacement: U3 at Node 919 in NSET DISPLAY_WITH_FEET', 
    steps=('turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy1 = abs(xy0)
session.XYData(name='max_displaycment_abs_feet_right', objectToCopy=xy1, 
    sourceDescription='abs(max_displaycment_abs_feet_right)')
del session.xyDataObjects[xy0.name]
del session.xyDataObjects[xy1.name]
odb = session.odbs['Y:/feets.odb']
xy0 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 1 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy1 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 2 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy2 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 3 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy3 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 8 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy4 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 9 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy5 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 10 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy6 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 11 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy7 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 12 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy8 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 13 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy9 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 14 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy10 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 15 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy11 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 16 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy12 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 17 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy13 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 18 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy14 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 19 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy15 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 20 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy16 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 21 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy17 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 22 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy18 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 23 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy19 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 24 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy20 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 25 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy21 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 26 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy22 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 27 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy23 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 28 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy24 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 29 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy25 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 132 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy26 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 133 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy27 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 134 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy28 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 135 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy29 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 136 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy30 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 137 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy31 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 138 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy32 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 139 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy33 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 140 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy34 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 141 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy35 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 142 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy36 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 143 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy37 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 144 in NSET SET-6', steps=(
    'turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy38 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 1056 in NSET SET-6', 
    steps=('turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy39 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Reaction force: RF3 at Node 1057 in NSET SET-6', 
    steps=('turbo', ), suppressQuery=True, __linkedVpName__='Viewport: 1')
xy40 = sum((xy0, xy1, xy2, xy3, xy4, xy5, xy6, xy7, xy8, xy9, xy10, xy11, xy12, 
    xy13, xy14, xy15, xy16, xy17, xy18, xy19, xy20, xy21, xy22, xy23, xy24, 
    xy25, xy26, xy27, xy28, xy29, xy30, xy31, xy32, xy33, xy34, xy35, xy36, 
    xy37, xy38, xy39, ), )
session.XYData(name='rf_feet', objectToCopy=xy40, 
    sourceDescription='sum((rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, rf_feet, ),)')
del session.xyDataObjects[xy0.name]
del session.xyDataObjects[xy1.name]
del session.xyDataObjects[xy2.name]
del session.xyDataObjects[xy3.name]
...
del session.xyDataObjects[xy39.name]
del session.xyDataObjects[xy40.name]
xy1 = session.xyDataObjects['max_displaycment_abs_feet_right']
xy2 = session.xyDataObjects['rf_feet']
xy3 = combine(xy1, xy2/(312.6*221.2))
xy3.setValues(
    sourceDescription='combine ( "max_displaycment_abs_feet_right", "rf_feet"/(312.6*221.2))')
tmpName = xy3.name
session.xyDataObjects.changeKey(tmpName, 'stress_vs_disp_feet')
xy1 = session.xyDataObjects['max_displaycment_abs_feet_right']
xy2 = session.xyDataObjects['rf_feet']
xy3 = combine(xy1, xy2/(312.6*221.2))
xyp = session.xyPlots['XYPlot-1']
...
chartName = xyp.charts.keys()[0]
chart = xyp.charts[chartName]
chart.removeCurve(curve=('displaycment_plot_max', ), )
xyp = session.xyPlots['XYPlot-1']
chartName = xyp.charts.keys()[0]
chart = xyp.charts[chartName]
xy1 = session.xyDataObjects['maxU3displaycment']
...
chartName = xyp.charts.keys()[0]
chart = xyp.charts[chartName]
chart.removeCurve(curve=('maxU3displaycment', ), )
xyp = session.xyPlots['XYPlot-1']
chartName = xyp.charts.keys()[0]
chart = xyp.charts[chartName]
xy1 = session.xyDataObjects['max_displaycment_feet']
c1 = session.Curve(xyData=xy1)
chart.setValues(curvesToPlot=(c1, ), appendMode=True)
session.charts[chartName].autoColor(lines=True, symbols=True)
xyp = session.xyPlots['XYPlot-1']
...
chartName = xyp.charts.keys()[0]
chart = xyp.charts[chartName]
chart.removeCurve(curve=('max_displaycment_abs_feet_right', ), )
xyp = session.xyPlots['XYPlot-1']
chartName = xyp.charts.keys()[0]
chart = xyp.charts[chartName]
xy1 = session.xyDataObjects['abs_display_right']
...
chartName = xyp.charts.keys()[0]
chart = xyp.charts[chartName]
chart.removeCurve(curve=('max_displaycment_feet', ), )
xyp = session.xyPlots['XYPlot-1']
chartName = xyp.charts.keys()[0]
chart = xyp.charts[chartName]
chart.removeCurve(curve=('_temp_46', ), )
xyp = session.xyPlots['XYPlot-1']
chartName = xyp.charts.keys()[0]
chart = xyp.charts[chartName]
xy1 = session.xyDataObjects['max_displaycment_abs_feet_right']
...
chartName = xyp.charts.keys()[0]
chart = xyp.charts[chartName]
xy1 = session.xyDataObjects['stress_vs_disp_feet']
c1 = session.Curve(xyData=xy1)
chart.setValues(curvesToPlot=(c1, ), appendMode=True)
session.charts[chartName].autoColor(lines=True, symbols=True)
odb = session.odbs['Y:/turbo_job_10.odb']
...
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='U', outputPosition=NODAL, refinement=(COMPONENT, 'U3'), )
session.viewports['Viewport: 1'].view.setValues(nearPlane=1108.38, 
    farPlane=1406.25, width=505.635, height=222.722, cameraPosition=(358.369, 
    142.168, 1178.24), cameraUpVector=(-0.187799, 0.904626, -0.382601), 
    cameraTarget=(154.069, 45.791, 37.4833), viewOffsetX=47.8029, 
    viewOffsetY=27.9945)
session.viewports['Viewport: 1'].view.setValues(nearPlane=1068.07, 
    farPlane=1491.64, width=487.248, height=214.623, cameraPosition=(871.378, 
    -253.523, 936.153), cameraUpVector=(-0.503034, 0.846528, 0.174203), 
    cameraTarget=(209.497, 0.760605, 14.4124), viewOffsetX=46.0646, 
    viewOffsetY=26.9765)
session.viewports['Viewport: 1'].view.setValues(nearPlane=1073.46, 
    farPlane=1502.44, width=489.707, height=215.706, cameraPosition=(605.401, 
    -695.001, 838.029), cameraUpVector=(-0.224978, 0.901751, 0.369095), 
    cameraTarget=(170.072, -27.1865, -8.64999), viewOffsetX=46.2971, 
    viewOffsetY=27.1126)
session.viewports['Viewport: 1'].view.setValues(nearPlane=1059.33, 
    farPlane=1516.57, width=700.51, height=308.56, viewOffsetX=34.8621, 
    viewOffsetY=21.5064)
session.viewports['Viewport: 1'].view.setValues(nearPlane=1055.07, 
    farPlane=1514.11, width=697.691, height=307.319, cameraPosition=(624.709, 
    -608.794, 894.499), cameraUpVector=(-0.272558, 0.912922, 0.303787), 
    cameraTarget=(173.488, -20.721, -1.56078), viewOffsetX=34.7218, 
    viewOffsetY=21.4199)
odb = session.odbs['Y:/displaycment_history.odb']
session.viewports['Viewport: 1'].setValues(displayedObject=odb)
odb = session.odbs['Y:/feets.odb']
...
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='U', outputPosition=NODAL, refinement=(COMPONENT, 'U3'), )
session.viewports['Viewport: 1'].view.setValues(nearPlane=983.19, 
    farPlane=1423.72, width=938.592, height=413.431, cameraPosition=(483.243, 
    642.751, 995.055), cameraUpVector=(-0.86535, 0.381476, -0.325032), 
    cameraTarget=(155.454, 89.6835, 26.0363))
session.viewports['Viewport: 1'].view.setValues(nearPlane=985.793, 
    farPlane=1459.71, width=941.077, height=414.526, cameraPosition=(-557.503, 
    340.608, 932.001), cameraUpVector=(0.282701, 0.842724, -0.458144), 
    cameraTarget=(120.378, 79.5006, 23.9112))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1008.2, 
    farPlane=1483.12, width=962.47, height=423.949, cameraPosition=(-499.604, 
    -285.273, 948.163), cameraUpVector=(-0.128523, 0.980013, -0.151843), 
    cameraTarget=(123.212, 48.8628, 24.7024))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1026.51, 
    farPlane=1496.33, width=979.948, height=431.648, cameraPosition=(670.737, 
    -458.999, 966.856), cameraUpVector=(0.152972, 0.987691, 0.0326457), 
    cameraTarget=(200.972, 37.32, 25.9444))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1041.65, 
    farPlane=1498.2, width=994.401, height=438.014, cameraPosition=(434.558, 
    -764.496, 843.073), cameraUpVector=(0.350155, 0.897315, 0.268733), 
    cameraTarget=(182.525, 13.459, 16.2762))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1038.33, 
    farPlane=1484.14, width=991.233, height=436.619, cameraPosition=(511.741, 
    -491.638, 1015.33), cameraUpVector=(0.203281, 0.977045, 0.0637233), 
    cameraTarget=(189.03, 36.4554, 30.7935))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1060.88, 
    farPlane=1488.14, width=1012.76, height=446.103, cameraPosition=(81.096, 
    -940.322, 682.989), cameraUpVector=(-0.0755373, 0.82296, 0.563055), 
    cameraTarget=(155.454, 1.47286, 4.88193))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1061.81, 
    farPlane=1498.12, width=1013.65, height=446.493, cameraPosition=(256.149, 
    -1037.16, 523.694), cameraUpVector=(-0.232262, 0.704087, 0.671055), 
    cameraTarget=(170.784, -7.00728, -9.06767))
mdb.save()
#: The model database has been saved to "Y:\mb_sss_points.cae".
mdb.save()
#: The model database has been saved to "Y:\mb_sss_points.cae".
...
mdb.save()
#: The model database has been saved to "Y:\mb_sss_points.cae".
session.viewports['Viewport: 1'].view.setValues(nearPlane=1053.13, 
    farPlane=1491.14, width=1005.37, height=442.844, cameraPosition=(301.346, 
    -842.29, 795.936), cameraUpVector=(-0.275301, 0.840426, 0.466791), 
    cameraTarget=(174.918, 10.8153, 15.8313))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1030.28, 
    farPlane=1505.36, width=983.559, height=433.238, cameraPosition=(575.664, 
    -611.228, 919.802), cameraUpVector=(-0.0793749, 0.954999, 0.28579), 
    cameraTarget=(198.473, 30.656, 26.4674))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1044.05, 
    farPlane=1522.73, width=996.702, height=439.027, cameraPosition=(485.946, 
    -1061.34, 372.149), cameraUpVector=(-0.00943842, 0.647391, 0.7621), 
    cameraTarget=(191.048, -6.59374, -18.8547))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1051.7, 
    farPlane=1498.44, width=1004.01, height=442.245, cameraPosition=(334.435, 
    -895.471, 728.357), cameraUpVector=(-0.0441495, 0.843431, 0.535421), 
    cameraTarget=(176.824, 8.97861, 14.5874))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1019.44, 
    farPlane=1520.98, width=973.215, height=428.681, cameraPosition=(-314.13, 
    -755.805, 766.422), cameraUpVector=(0.0545078, 0.894946, 0.442833), 
    cameraTarget=(119.769, 21.2653, 17.936))
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='U', outputPosition=NODAL, refinement=(COMPONENT, 'U2'), )
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='U', outputPosition=NODAL, refinement=(COMPONENT, 'U1'), )
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='U', outputPosition=NODAL, refinement=(COMPONENT, 'U3'), )
session.viewports['Viewport: 1'].view.setValues(nearPlane=1034.73, 
    farPlane=1514.26, width=987.808, height=435.11, cameraPosition=(510.443, 
    -855.285, 717.828), cameraUpVector=(-0.19961, 0.814473, 0.544784), 
    cameraTarget=(189.431, 12.8611, 13.8307))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1045.88, 
    farPlane=1501.96, width=998.453, height=439.799, cameraPosition=(387.26, 
    -866.348, 749.781), cameraUpVector=(-0.17095, 0.83602, 0.521389), 
    cameraTarget=(178.645, 11.8924, 16.6285))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1026.22, 
    farPlane=1508.51, width=979.687, height=431.532, cameraPosition=(-295, 
    -609.789, 905.405), cameraUpVector=(-0.217272, 0.962484, 0.162537), 
    cameraTarget=(119.188, 34.2508, 30.1907))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1036.67, 
    farPlane=1478.94, width=989.661, height=435.925, cameraPosition=(821.42, 
    -34.9311, 1022.93), cameraUpVector=(-0.611952, 0.786954, 0.0788551), 
    cameraTarget=(211.21, 81.6341, 39.878))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1003.81, 
    farPlane=1492.98, width=958.288, height=422.106, cameraPosition=(773.946, 
    583.571, 941.685), cameraUpVector=(-0.765226, 0.59424, -0.247605), 
    cameraTarget=(207.628, 128.302, 33.7478))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1029.28, 
    farPlane=1439.31, width=982.605, height=432.817, cameraPosition=(134.783, 
    1105.58, -765.062), cameraUpVector=(-0.869697, -0.488706, -0.069234), 
    cameraTarget=(163.855, 164.051, -83.1373))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1026.8, 
    farPlane=1445.63, width=980.241, height=431.776, cameraPosition=(-137.379, 
    548.357, -1153.12), cameraUpVector=(-0.638927, -0.725535, 0.255678), 
    cameraTarget=(148.113, 131.821, -105.583))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1021.86, 
    farPlane=1445.01, width=975.522, height=429.698, cameraPosition=(108.001, 
    1202.25, -607.102), cameraUpVector=(-0.870712, -0.479172, -0.110707), 
    cameraTarget=(162.665, 170.6, -73.2017))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1045.49, 
    farPlane=1413.33, width=998.08, height=439.635, cameraPosition=(432.344, 
    282.035, 1150.87), cameraUpVector=(-0.724955, 0.631444, -0.275172), 
    cameraTarget=(181.212, 117.978, 27.3279))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1038.36, 
    farPlane=1419.41, width=991.269, height=436.635, cameraPosition=(188.273, 
    -534.982, 1010.35), cameraUpVector=(-0.556211, 0.821593, 0.124961), 
    cameraTarget=(168.007, 73.776, 19.7254))
session.viewports['Viewport: 1'].view.setValues(nearPlane=998.654, 
    farPlane=1465.07, width=953.366, height=419.938, cameraPosition=(465.214, 
    -722.004, 818.913), cameraUpVector=(-0.51731, 0.743693, 0.423451), 
    cameraTarget=(182.877, 63.7339, 9.44621))
session.viewports['Viewport: 1'].view.setValues(nearPlane=990.297, 
    farPlane=1475.59, width=945.388, height=416.424, cameraPosition=(562.309, 
    -775.724, 720.019), cameraUpVector=(-0.482271, 0.6994, 0.527498), 
    cameraTarget=(188.313, 60.7265, 3.9099))
session.viewports['Viewport: 1'].view.setValues(nearPlane=992.696, 
    farPlane=1472.83, width=947.678, height=417.433, cameraPosition=(555.453, 
    -742.45, 760.62), cameraUpVector=(-0.491387, 0.718468, 0.492282), 
    cameraTarget=(187.923, 62.6169, 6.21653))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1023.47, 
    farPlane=1442.16, width=977.06, height=430.375, cameraPosition=(290.033, 
    -1105.85, 114.504), cameraUpVector=(-0.157257, 0.433653, 0.887252), 
    cameraTarget=(172.881, 42.0222, -30.4002))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1021.92, 
    farPlane=1440.17, width=975.576, height=429.722, cameraPosition=(64.4351, 
    -1106.94, 122.418), cameraUpVector=(0.195545, 0.437518, 0.87769), 
    cameraTarget=(160.086, 41.9605, -29.9514))
session.viewports['Viewport: 1'].animationController.setValues(
    animationType=TIME_HISTORY)
session.viewports['Viewport: 1'].animationController.play(duration=UNLIMITED)
session.viewports['Viewport: 1'].view.setValues(nearPlane=944.973, 
    farPlane=1477.31, width=902.12, height=397.366, cameraPosition=(126.53, 
    -996.341, 500.383), cameraUpVector=(0.337306, 0.678769, 0.652302), 
    cameraTarget=(163.256, 47.6067, -10.6556))
session.viewports['Viewport: 1'].view.setValues(nearPlane=1004.11, 
    farPlane=1446.7, width=958.574, height=422.233, cameraPosition=(247.842, 
    -1104.52, 143.924), cameraUpVector=(0.166915, 0.476257, 0.863318), 
    cameraTarget=(168.088, 43.2977, -24.854))
session.viewports['Viewport: 1'].view.setValues(nearPlane=957.265, 
    farPlane=1471.14, width=913.854, height=402.535, cameraPosition=(146.691, 
    -1023.18, 444.153), cameraUpVector=(-0.135169, 0.672477, 0.727671), 
    cameraTarget=(162.928, 47.447, -9.53958))
session.viewports['Viewport: 1'].view.setValues(nearPlane=951.972, 
    farPlane=1472.93, width=908.801, height=400.309, cameraPosition=(131.803, 
    -1002.5, 489.55), cameraUpVector=(-0.0893013, 0.704562, 0.704001), 
    cameraTarget=(162.299, 48.3205, -7.62156))
session.viewports['Viewport: 1'].view.setValues(nearPlane=987.046, 
    farPlane=1437.85, width=456.1, height=200.903, viewOffsetX=-10.013, 
    viewOffsetY=17.125)
session.viewports['Viewport: 1'].view.setValues(nearPlane=1012.5, 
    farPlane=1418.84, width=467.861, height=206.083, cameraPosition=(251.616, 
    -1073.2, 270.605), cameraUpVector=(-0.074916, 0.553271, 0.829626), 
    cameraTarget=(166.196, 49.8611, -18.8272), viewOffsetX=-10.2712, 
    viewOffsetY=17.5666)
session.viewports['Viewport: 1'].view.setValues(session.views['Front'])
session.viewports['Viewport: 1'].view.setValues(session.views['Top'])
session.viewports['Viewport: 1'].view.setValues(session.views['Bottom'])
session.viewports['Viewport: 1'].view.setValues(nearPlane=849.092, 
    farPlane=1317.18, width=796.985, height=351.056, cameraPosition=(187.105, 
    -935.351, 287.435), cameraUpVector=(0.00983033, 0.258579, 0.96594))
session.viewports['Viewport: 1'].view.setValues(nearPlane=878.918, 
    farPlane=1287.36, width=502.883, height=221.51, viewOffsetX=-1.6415, 
    viewOffsetY=-14.0447)
session.viewports['Viewport: 1'].view.setValues(nearPlane=881.291, 
    farPlane=1284.98, width=504.241, height=222.108, viewOffsetX=4.35016, 
    viewOffsetY=-45.1721)
session.viewports['Viewport: 1'].view.setValues(nearPlane=888.086, 
    farPlane=1278.19, width=396.721, height=174.748, viewOffsetX=-6.27763, 
    viewOffsetY=-37.5685)
session.imageAnimationOptions.setValues(vpDecorations=ON, vpBackground=OFF, 
    compass=OFF)
session.writeImageAnimation(fileName='feet_displacement', format=AVI, 
...
session.viewports['Viewport: 1'].makeCurrent()
session.viewports['Viewport: 1'].view.setValues(session.views['Bottom'])
session.viewports['Viewport: 1'].view.setValues(nearPlane=838.225, 
    farPlane=1328.05, width=786.786, height=346.563, cameraPosition=(4.02895, 
    -933.926, 250.575), cameraUpVector=(-0.0298143, 0.230456, 0.972626), 
    cameraTarget=(156.3, 110.6, 7.75))
session.viewports['Viewport: 1'].view.setValues(nearPlane=868.229, 
    farPlane=1298.04, width=500.84, height=220.61, viewOffsetX=11.3833, 
    viewOffsetY=-3.90447)
session.viewports['Viewport: 1'].view.setValues(session.views['Bottom'])
session.viewports['Viewport: 1'].view.setValues(nearPlane=931.749, 
    farPlane=1234.52, width=471.057, height=207.491, viewOffsetX=-7.92687, 
    viewOffsetY=-6.58231)
session.viewports['Viewport: 1'].view.setValues(nearPlane=889.693, 
    farPlane=1272.88, width=449.795, height=198.126, cameraPosition=(167.839, 
    -941.885, 255.391), cameraUpVector=(0.0329731, 0.229341, 0.972787), 
    cameraTarget=(156.547, 112.379, 7.224), viewOffsetX=-7.56908, 
    viewOffsetY=-6.28521)
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='U', outputPosition=NODAL, refinement=(INVARIANT, 
    'Magnitude'), )
...
session.viewports['Viewport: 1'].animationController.setValues(
    animationType=TIME_HISTORY)
session.viewports['Viewport: 1'].animationController.play(duration=UNLIMITED)
session.viewports['Viewport: 1'].view.setValues(nearPlane=897.268, 
    farPlane=1266.74, width=453.626, height=199.813, cameraPosition=(125.375, 
    -952.84, 204.906), cameraUpVector=(-0.0297371, 0.182596, 0.982738), 
    cameraTarget=(156.137, 111.809, 8.0214), viewOffsetX=-7.63353, 
    viewOffsetY=-6.33873)
session.viewports['Viewport: 1'].view.setValues(nearPlane=894.678, 
    farPlane=1269.33, width=511.902, height=225.483, viewOffsetX=-5.5196, 
    viewOffsetY=-5.84155)
session.viewports['Viewport: 1'].view.setValues(nearPlane=892.384, 
    farPlane=1271.62, width=510.589, height=224.904, viewOffsetX=30.0566, 
    viewOffsetY=-34.4714)
session.viewports['Viewport: 1'].view.setValues(nearPlane=892.378, 
    farPlane=1271.63, width=510.586, height=224.903, viewOffsetX=52.6078, 
    viewOffsetY=-67.9371)
session.viewports['Viewport: 1'].view.setValues(nearPlane=892.379, 
    farPlane=1271.63, width=510.586, height=224.903, viewOffsetX=5.19212, 
    viewOffsetY=-72.4749)
session.imageAnimationOptions.setValues(vpDecorations=ON, vpBackground=OFF, 
    compass=OFF)
session.writeImageAnimation(fileName='ss_displacement', format=AVI, 
    canvasObjects=(session.viewports['Viewport: 1'], ))
session.imageAnimationOptions.setValues(vpDecorations=ON, vpBackground=OFF, 
    compass=OFF)
session.writeImageAnimation(fileName='ss_displacement', format=QUICKTIME, 
    canvasObjects=(session.viewports['Viewport: 1'], ))
session.viewports['Viewport: 1'].view.setValues(farPlane=1271.63, 
    viewOffsetX=6.3486, viewOffsetY=-51.7713)
session.viewports['Viewport: 1'].view.setValues(farPlane=1271.63, 
    viewOffsetX=1.14444, viewOffsetY=-37.3072)
session.viewports['Viewport: 1'].animationController.setValues(
    animationType=NONE)
odb = session.odbs['Y:/turbo_job.odb']
session.viewports['Viewport: 1'].setValues(displayedObject=odb)
...
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='U', outputPosition=NODAL, refinement=(COMPONENT, 'U3'), )
session.viewports['Viewport: 1'].view.setValues(width=564.362, height=248.59, 
    viewOffsetX=17.909, viewOffsetY=-46.1447)
a = mdb.models['Model-1'].rootAssembly
session.viewports['Viewport: 1'].setValues(displayedObject=a)
session.viewports['Viewport: 1'].assemblyDisplay.setValues(loads=ON, bcs=ON, 
    predefinedFields=ON, connectors=ON)
session.viewports['Viewport: 1'].view.setValues(width=499.801, height=212.379, 
    viewOffsetX=29.0559, viewOffsetY=-1.43802)
session.viewports['Viewport: 1'].view.setValues(nearPlane=617.829, 
    farPlane=931.548, width=496.846, height=211.123, cameraPosition=(304.265, 
    -466.317, 503.195), cameraUpVector=(0.0160921, 0.650397, 0.759424), 
    cameraTarget=(164.04, 107.512, 14.7165), viewOffsetX=28.8841, 
    viewOffsetY=-1.42952)
session.viewports['Viewport: 1'].view.setValues(nearPlane=617.813, 
    farPlane=931.563, width=496.833, height=211.118, cameraPosition=(304.889, 
    -472.412, 495.856), cameraUpVector=(-0.241368, 0.594165, 0.767274), 
    cameraTarget=(164.663, 101.417, 7.37751), viewOffsetX=28.8833, 
    viewOffsetY=-1.42948)
session.viewports['Viewport: 1'].view.setValues(nearPlane=617.813, 
    farPlane=931.563, width=496.833, height=211.118, cameraPosition=(304.191, 
    -468.147, 501.066), cameraUpVector=(-0.0600227, 0.63849, 0.767286), 
    cameraTarget=(163.965, 105.682, 12.588), viewOffsetX=28.8833, 
    viewOffsetY=-1.42948)
session.viewports['Viewport: 1'].view.setValues(nearPlane=617.514, 
    farPlane=937.411, width=496.593, height=211.016, cameraPosition=(352.391, 
    -420.068, 541.07), cameraUpVector=(-0.0280543, 0.701426, 0.71219), 
    cameraTarget=(164.962, 105.772, 15.7931), viewOffsetX=28.8693, 
    viewOffsetY=-1.42879)
session.printOptions.setValues(compass=ON)
session.printToFile(fileName='load_feet', format=PNG, canvasObjects=(
    session.viewports['Viewport: 1'], ))
session.viewports['Viewport: 1'].view.setValues(nearPlane=630.854, 
    farPlane=909.955, width=507.322, height=215.575, cameraPosition=(224.739, 
    -452.012, 529.615), cameraUpVector=(-0.0186931, 0.676679, 0.736041), 
    cameraTarget=(162.205, 109.604, 11.7051), viewOffsetX=29.493, 
    viewOffsetY=-1.45966)
session.viewports['Viewport: 1'].view.setValues(nearPlane=636.784, 
    farPlane=904.025, width=399.815, height=169.892, viewOffsetX=15.084, 
    viewOffsetY=5.81898)
session.viewports['Viewport: 1'].view.setValues(nearPlane=638.753, 
    farPlane=902.055, width=401.051, height=170.417, viewOffsetX=-12.348, 
    viewOffsetY=-9.53401)
session.viewports['Viewport: 1'].view.setValues(nearPlane=640.621, 
    farPlane=900.188, width=355.405, height=151.021, viewOffsetX=-15.3269, 
    viewOffsetY=-8.04054)
session.printToFile(fileName='load_feet', format=PNG, canvasObjects=(
    session.viewports['Viewport: 1'], ))
session.viewports['Viewport: 1'].view.setValues(nearPlane=642.298, 
    farPlane=898.511, width=356.335, height=151.416, viewOffsetX=-8.50662, 
    viewOffsetY=-10.4368)
mdb.openAuxMdb(pathName='Y:/mb_rot.cae')
mdb.copyAuxMdbModel(fromName='Model-1', toName='model_without_feet')
mdb.closeAuxMdb()
a = mdb.models['model_without_feet'].rootAssembly
session.viewports['Viewport: 1'].setValues(displayedObject=a)
a.regenerate()
session.viewports['Viewport: 1'].assemblyDisplay.setValues(step='Initial')
session.viewports['Viewport: 1'].assemblyDisplay.setValues(step='simple_test')
session.viewports['Viewport: 1'].view.setValues(nearPlane=678.546, 
    farPlane=941.727, width=648.911, height=275.74, cameraPosition=(466.181, 
    229.672, 746.864), cameraUpVector=(-0.0167891, 0.86608, -0.499624), 
    cameraTarget=(167.147, 106.493, 1.01038))
session.viewports['Viewport: 1'].view.setValues(nearPlane=675.818, 
    farPlane=944.456, width=646.302, height=274.631, cameraPosition=(466.181, 
    229.672, 746.864), cameraUpVector=(-0.254219, 0.877644, -0.406341), 
    cameraTarget=(167.147, 106.493, 1.01038))
session.viewports['Viewport: 1'].view.setValues(nearPlane=663.326, 
    farPlane=953.946, width=634.356, height=269.555, cameraPosition=(104.59, 
    -439.575, 598.254), cameraUpVector=(-0.0675158, 0.920579, 0.384677), 
    cameraTarget=(168.404, 108.819, 1.52689))
session.viewports['Viewport: 1'].view.setValues(nearPlane=659.331, 
    farPlane=956.016, width=630.535, height=267.931, cameraPosition=(59.4403, 
    -403.31, 623.396), cameraUpVector=(0.0226049, 0.939569, 0.341611), 
    cameraTarget=(168.645, 108.625, 1.39269))
session.viewports['Viewport: 1'].view.setValues(nearPlane=662.446, 
    farPlane=957.723, width=633.514, height=269.197, cameraPosition=(145.221, 
    -530.068, 503.555), cameraUpVector=(-0.0135662, 0.844254, 0.535771), 
    cameraTarget=(168.084, 109.453, 2.17592))
session.viewports['Viewport: 1'].view.setValues(nearPlane=681.572, 
    farPlane=938.598, width=373.481, height=158.702, viewOffsetX=-13.0809, 
    viewOffsetY=1.62327)
session.viewports['Viewport: 1'].view.setValues(nearPlane=684.183, 
    farPlane=936.011, width=374.912, height=159.31, cameraPosition=(154.164, 
    -537.719, 493.649), cameraUpVector=(-0.021513, 0.835683, 0.54879), 
    cameraTarget=(168.063, 109.675, 2.14299), viewOffsetX=-13.131, 
    viewOffsetY=1.62949)
session.viewports['Viewport: 1'].view.setValues(nearPlane=684.072, 
    farPlane=936.123, width=374.851, height=159.284, viewOffsetX=-17.3741, 
    viewOffsetY=-3.99257)
session.viewports['Viewport: 1'].view.setValues(nearPlane=684.071, 
    farPlane=936.123, width=374.851, height=159.284, viewOffsetX=-15.2515, 
    viewOffsetY=-3.57613)
session.printToFile(fileName='load_ss', format=PNG, canvasObjects=(
    session.viewports['Viewport: 1'], ))
odb = session.odbs['Y:/turbo_job_10.odb']
session.viewports['Viewport: 1'].setValues(displayedObject=odb)
xyp = session.xyPlots['XYPlot-1']
...
chart.setValues(curvesToPlot=(c1, ), appendMode=True)
session.charts[chartName].autoColor(lines=True, symbols=True)
session.printToFile(fileName='feet_vs_ss_displacement', format=PNG, 
    canvasObjects=(session.viewports['Viewport: 1'], ))
xyp = session.xyPlots['XYPlot-1']
chartName = xyp.charts.keys()[0]
chart = xyp.charts[chartName]
...
xy1 = session.xyDataObjects['abs_display_right']
xy2 = swap(xy1)
xy2.setValues(sourceDescription='swap ( "abs_display_right" )')
tmpName = xy2.name
session.xyDataObjects.changeKey(tmpName, 'displacement_ss_right')
xyp = session.xyPlots['XYPlot-1']
chartName = xyp.charts.keys()[0]
chart = xyp.charts[chartName]
xy1 = session.xyDataObjects['displacement_ss_right']
c1 = session.Curve(xyData=xy1)
chart.setValues(curvesToPlot=(c1, ), )
session.charts[chartName].autoColor(lines=True, symbols=True)
xyp = session.xyPlots['XYPlot-1']
...
xy1 = session.xyDataObjects['stress_vs_disp_feet']
xy2 = swap(xy1)
xy2.setValues(sourceDescription='swap ( "stress_vs_disp_feet" )')
tmpName = xy2.name
session.xyDataObjects.changeKey(tmpName, 'displacement_feet_right')
xyp = session.xyPlots['XYPlot-1']
chartName = xyp.charts.keys()[0]
chart = xyp.charts[chartName]
xy1 = session.xyDataObjects['displacement_feet_right']
c1 = session.Curve(xyData=xy1)
chart.setValues(curvesToPlot=(c1, ), appendMode=True)
session.charts[chartName].autoColor(lines=True, symbols=True)
session.printToFile(fileName='feet_vs_ss_displacement_force', format=PNG, 
    canvasObjects=(session.viewports['Viewport: 1'], ))
odb = session.odbs['Y:/turbo_job.odb']
session.viewports['Viewport: 1'].setValues(displayedObject=odb)
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
...
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='U', outputPosition=NODAL, refinement=(COMPONENT, 'U3'), )
session.viewports['Viewport: 1'].view.setValues(nearPlane=1000.44, 
    farPlane=1345.66, width=414.002, height=182.36, viewOffsetX=-1.39816, 
    viewOffsetY=-13.5123)
odb = session.odbs['Y:/turbo_job_10.odb']
session.viewports['Viewport: 1'].setValues(displayedObject=odb)
session.viewports['Viewport: 1'].view.setValues(nearPlane=904.954, 
    farPlane=1259.05, width=335.77, height=147.9, viewOffsetX=12.3012, 
    viewOffsetY=-29.4865)
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='U', outputPosition=NODAL, refinement=(INVARIANT, 
    'Magnitude'), )
session.viewports['Viewport: 1'].odbDisplay.display.setValues(
    plotState=CONTOURS_ON_DEF)
session.viewports['Viewport: 1'].view.setValues(nearPlane=930.374, 
    farPlane=1259.95, width=500.386, height=220.41, viewOffsetX=51.131, 
    viewOffsetY=-32.1155)
session.viewports['Viewport: 1'].view.setValues(nearPlane=928.119, 
    farPlane=1262.2, width=499.174, height=219.876, viewOffsetX=18.2188, 
    viewOffsetY=-64.7557)
session.viewports['Viewport: 1'].view.setValues(nearPlane=932.762, 
    farPlane=1257.56, width=416.68, height=183.539, viewOffsetX=7.72215, 
    viewOffsetY=-58.1163)
session.viewports['Viewport: 1'].view.setValues(nearPlane=934.847, 
    farPlane=1255.48, width=417.611, height=183.949, viewOffsetX=8.68531, 
    viewOffsetY=-54.3028)
session.printToFile(fileName='displacements_10mm', format=PNG, canvasObjects=(
    session.viewports['Viewport: 1'], ))
odb = session.odbs['Y:/turbo_job.odb']
session.viewports['Viewport: 1'].setValues(displayedObject=odb)
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
...
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='U', outputPosition=NODAL, refinement=(COMPONENT, 'U3'), )
session.viewports['Viewport: 1'].view.setValues(nearPlane=1004.48, 
    farPlane=1341.62, width=415.673, height=183.096, viewOffsetX=-1.4038, 
    viewOffsetY=-13.5669)
session.viewports['Viewport: 1'].view.setValues(nearPlane=1002.45, 
    farPlane=1343.65, width=414.835, height=182.726, viewOffsetX=-5.86407, 
    viewOffsetY=-19.9914)
p = mdb.models['model_without_feet'].parts['Part-1']
session.viewports['Viewport: 1'].setValues(displayedObject=p)
odb = session.odbs['Y:/turbo_job.odb']
session.viewports['Viewport: 1'].setValues(displayedObject=odb)
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=0, frame=0 )
session.viewports['Viewport: 1'].view.setValues(nearPlane=944.267, 
    farPlane=1352.18, width=345.273, height=152.086, viewOffsetX=-13.5852, 
    viewOffsetY=-12.856)
session.viewports['Viewport: 1'].view.setValues(session.views['Back'])
odb = session.odbs['Y:/turbo_job_10.odb']
session.viewports['Viewport: 1'].setValues(displayedObject=odb)
...
session.viewports['Viewport: 1'].view.setValues(session.views['Back'])
session.viewports['Viewport: 1'].view.setValues(session.views['Front'])
session.viewports['Viewport: 1'].view.setValues(nearPlane=619.225, 
    farPlane=1018.37, width=437.44, height=192.683, cameraPosition=(-14.9987, 
    -651.199, 181.84), cameraUpVector=(-0.117852, 0.329581, 0.936743))
session.viewports['Viewport: 1'].view.setValues(nearPlane=625.71, 
    farPlane=1011.89, width=442.021, height=194.701, cameraPosition=(-14.9987, 
    -651.199, 181.84), cameraUpVector=(-0.0188773, 0.311621, 0.950019), 
    cameraTarget=(156.3, 110.6, -64.6378))
session.viewports['Viewport: 1'].view.setValues(nearPlane=645.486, 
    farPlane=992.112, width=455.991, height=200.855, cameraPosition=(93.2878, 
    -677.866, 146.983), cameraUpVector=(-0.0306008, 0.261381, 0.96475), 
    cameraTarget=(156.3, 110.6, -64.6378))
session.viewports['Viewport: 1'].view.setValues(nearPlane=648.619, 
    farPlane=988.98, width=380.578, height=167.637, viewOffsetX=-3.38465, 
    viewOffsetY=5.58389)
session.viewports['Viewport: 1'].view.setValues(nearPlane=650.501, 
    farPlane=987.098, width=381.682, height=168.123, cameraPosition=(93.0788, 
    -677.885, 146.852), cameraUpVector=(-0.000659306, 0.259271, 0.965804), 
    cameraTarget=(156.091, 110.581, -64.7691), viewOffsetX=-3.39447, 
    viewOffsetY=5.60009)
odb = session.odbs['Y:/turbo_job.odb']
session.viewports['Viewport: 1'].setValues(displayedObject=odb)
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
...
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='U', outputPosition=NODAL, refinement=(COMPONENT, 'U3'), )
session.viewports['Viewport: 1'].view.setValues(session.views['Front'])
session.viewports['Viewport: 1'].view.setValues(nearPlane=636.3, 
    farPlane=1001.8, width=449.458, height=197.977, cameraPosition=(247.754, 
    -370.263, 591.883), cameraUpVector=(-0.118781, 0.793155, 0.597324), 
    cameraTarget=(156.3, 110.6, -64.8157))
session.viewports['Viewport: 1'].view.setValues(nearPlane=645.473, 
    farPlane=992.631, width=455.938, height=200.831, cameraPosition=(180.883, 
    -567.41, 394.035), cameraUpVector=(0.119733, 0.559416, 0.820194), 
    cameraTarget=(156.3, 110.6, -64.8152))
session.viewports['Viewport: 1'].view.setValues(nearPlane=632.755, 
    farPlane=1005.35, width=446.954, height=196.874, cameraPosition=(37.3943, 
    -659.093, 188.72), cameraUpVector=(-0.131701, 0.328432, 0.935301), 
    cameraTarget=(156.3, 110.6, -64.8153))
session.viewports['Viewport: 1'].view.setValues(nearPlane=633.488, 
    farPlane=1004.62, width=447.472, height=197.102, cameraPosition=(37.3943, 
    -659.093, 188.72), cameraUpVector=(0.0371064, 0.30747, 0.950834), 
    cameraTarget=(156.3, 110.6, -64.8153))
session.viewports['Viewport: 1'].view.setValues(nearPlane=633.446, 
    farPlane=1004.66, width=447.442, height=197.089, cameraPosition=(37.3943, 
    -659.093, 188.72), cameraUpVector=(0.0482807, 0.30576, 0.950884))
session.viewports['Viewport: 1'].view.setValues(nearPlane=635.025, 
    farPlane=1003.08, width=448.558, height=197.58, cameraPosition=(34.8448, 
    -671.232, 146.924), cameraUpVector=(0.0617231, 0.251965, 0.965766), 
    cameraTarget=(156.3, 110.6, -64.8154))
session.viewports['Viewport: 1'].view.setValues(nearPlane=634.934, 
    farPlane=1003.17, width=448.494, height=197.552, cameraPosition=(34.8448, 
    -671.232, 146.924), cameraUpVector=(0.0105979, 0.259859, 0.965588))
session.viewports['Viewport: 1'].view.setValues(nearPlane=639.088, 
    farPlane=999.016, width=374.949, height=165.157, viewOffsetX=-3.42386, 
    viewOffsetY=4.48725)
session.viewports['Viewport: 1'].view.setValues(nearPlane=650.148, 
    farPlane=986.611, width=381.438, height=168.016, cameraPosition=(69.7415, 
    -690.125, 80.4173), cameraUpVector=(-0.00615429, 0.179108, 0.98381), 
    cameraTarget=(156.42, 111.253, -64.9353), viewOffsetX=-3.48311, 
    viewOffsetY=4.56491)
session.viewports['Viewport: 1'].view.setValues(nearPlane=649.644, 
    farPlane=987.116, width=381.143, height=167.886, viewOffsetX=-0.458892, 
    viewOffsetY=-6.44753)
session.printToFile(fileName='displacements_5mm', format=PNG, canvasObjects=(
    session.viewports['Viewport: 1'], ))
mdb.save()
#: The model database has been saved to "Y:\mb_sss_points.cae".
mdb.save()
