...
options = {
    ...
    'input':'displaycment_history',
    'inputFormat':INP,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'jleJobExcluded':False,
    'job':'displaycment_history',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'listener_name':'vwhresxaas15.hybridres.polimi.it',
    'listener_resource':'1460',
    'magnetostatic':OFF,
    'massDiffusion':OFF,
    ...
    'mp_head_node':('vwhresxaas15.hybridres.polimi.it', 'vwhresxaas15', '10.5.22.65', '10.5.28.65'),
    'mp_host_list':(('vwhresxaas15', 4),),
    'mp_mode':MPI,
