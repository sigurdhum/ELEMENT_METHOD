...
session.viewports['Viewport: 1'].partDisplay.geometryOptions.setValues(
    referenceRepresentation=OFF)
odb = session.odbs['Y:/mb_us_randomM.odb']
session.viewports['Viewport: 1'].setValues(displayedObject=odb)
session.viewports['Viewport: 1'].view.setValues(nearPlane=957.097, 
    farPlane=1386.74, width=592.398, height=295.366, viewOffsetX=13.1359, 
    viewOffsetY=19.5306)
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=1, frame=0 )
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=1, frame=1 )
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=1, frame=0 )
...
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=1, frame=0 )
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=1, frame=1 )
session.viewports['Viewport: 1'].view.setValues(nearPlane=1031.54, 
    farPlane=1314.86, width=638.471, height=318.338, cameraPosition=(555.946, 
    138.252, 1072.65), cameraUpVector=(-0.129322, 0.847773, -0.514351), 
    cameraTarget=(147.545, -110.009, 12.5086), viewOffsetX=14.1575, 
    viewOffsetY=21.0496)
session.viewports['Viewport: 1'].view.setValues(nearPlane=1069.55, 
    farPlane=1276.62, width=661.996, height=330.067, cameraPosition=(307.402, 
    32.1584, 1149.89), cameraUpVector=(-0.0618788, 0.89406, -0.443652), 
    cameraTarget=(144.577, -112.397, 7.55647), viewOffsetX=14.6791, 
    viewOffsetY=21.8252)
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=1, frame=0 )
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=0, frame=1 )
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=1, frame=0 )
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=1, frame=1 )
session.viewports['Viewport: 1'].view.setValues(nearPlane=986.476, 
    farPlane=1364.91, width=610.578, height=304.431, cameraPosition=(896.947, 
    -363.291, 862.524), cameraUpVector=(-0.228742, 0.973179, 0.0244701), 
    cameraTarget=(153.242, -118.163, 2.78664), viewOffsetX=13.5389, 
    viewOffsetY=20.13)
mdb.save()
#: The model database has been saved to "Y:\mb_16_v2.cae".
a = mdb.models['Model-1'].rootAssembly
...
session.viewports['Viewport: 1'].assemblyDisplay.setValues(loads=ON, bcs=ON, 
    predefinedFields=ON, connectors=ON)
session.viewports['Viewport: 1'].view.setValues(nearPlane=641.927, 
    farPlane=1089.75, width=801.631, height=387.114, viewOffsetX=134.815, 
    viewOffsetY=60.2351)
session.viewports['Viewport: 1'].view.setValues(nearPlane=656.129, 
    farPlane=1076.29, width=819.366, height=395.679, cameraPosition=(329.056, 
    -896.611, 299.575), cameraUpVector=(-0.339758, 0.637361, 0.691618), 
    cameraTarget=(85.2969, -210.024, -61.084), viewOffsetX=137.797, 
    viewOffsetY=61.5678)
session.viewports['Viewport: 1'].view.setValues(nearPlane=679.29, 
    farPlane=1108, width=848.289, height=409.646, cameraPosition=(641.269, 
    -585.649, 587.795), cameraUpVector=(-0.47868, 0.77404, 0.4144), 
    cameraTarget=(139.272, -253.474, 41.3942), viewOffsetX=142.661, 
    viewOffsetY=63.7411)
session.viewports['Viewport: 1'].assemblyDisplay.setValues(step='uniform_load')
session.viewports['Viewport: 1'].view.setValues(nearPlane=677.154, 
    farPlane=1110.14, width=845.622, height=408.358, cameraPosition=(659.388, 
    -594.855, 565.552), cameraUpVector=(-0.57655, 0.682752, 0.44882), 
    cameraTarget=(157.391, -262.68, 19.1511), viewOffsetX=142.212, 
    viewOffsetY=63.5407)
session.viewports['Viewport: 1'].view.setValues(nearPlane=659.942, 
    farPlane=1121.32, width=824.129, height=397.979, cameraPosition=(642.518, 
    -704.667, 453.587), cameraUpVector=(-0.492913, 0.652664, 0.575383), 
    cameraTarget=(141.478, -260.993, -7.94094), viewOffsetX=138.597, 
    viewOffsetY=61.9256)
session.viewports['Viewport: 1'].view.setValues(nearPlane=691.392, 
    farPlane=1089.87, width=437.14, height=211.099, viewOffsetX=114.407, 
    viewOffsetY=75.1452)
session.viewports['Viewport: 1'].setValues(
    displayedObject=session.odbs['Y:/mb_us_randomM.odb'])
odb = session.odbs['Y:/mb_us_randomM.odb']
session.viewports['Viewport: 1'].setValues(displayedObject=odb)
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='U', outputPosition=NODAL, refinement=(COMPONENT, 'U2'), )
...
p = mdb.models['Model-1'].parts['mb_16']
f = p.faces
pickedRegions = f.getSequenceFromMask(mask=('[#8f ]', ), )
p.deleteMesh(regions=pickedRegions)
p = mdb.models['Model-1'].parts['mb_16']
f1, e, d2 = p.faces, p.edges, p.datums
t = p.MakeSketchTransform(sketchPlane=f1[2], sketchUpEdge=e[17], 
    sketchPlaneSide=SIDE1, origin=(156.3, -85.6, 7.75))
s = mdb.models['Model-1'].ConstrainedSketch(name='__profile__', 
    sheetSize=765.89, gridSpacing=19.14, transform=t)
g, v, d, c = s.geometry, s.vertices, s.dimensions, s.constraints
...
a = mdb.models['Model-1'].rootAssembly
session.viewports['Viewport: 1'].setValues(displayedObject=a)
session.viewports['Viewport: 1'].view.setValues(nearPlane=689.002, 
    farPlane=1086.36, width=435.629, height=210.369, cameraPosition=(555.08, 
    -803.539, 380.327), cameraUpVector=(-0.421153, 0.638607, 0.644059), 
    cameraTarget=(119.151, -253.255, -29.6105), viewOffsetX=114.011, 
    viewOffsetY=74.8854)
session.viewports['Viewport: 1'].view.setValues(nearPlane=689.239, 
    farPlane=1086.12, width=435.779, height=210.441, cameraPosition=(544.064, 
    -802.174, 393.873), cameraUpVector=(-0.344509, 0.692066, 0.634317), 
    cameraTarget=(108.135, -251.89, -16.0647), viewOffsetX=114.05, 
    viewOffsetY=74.9111)
session.viewports['Viewport: 1'].view.setValues(nearPlane=683.63, 
    farPlane=1105.88, width=432.233, height=208.728, cameraPosition=(830.318, 
    -613.841, 313.494), cameraUpVector=(-0.570389, 0.421467, 0.704998), 
    cameraTarget=(186.866, -259.351, -34.6479), viewOffsetX=113.122, 
    viewOffsetY=74.3015)
session.viewports['Viewport: 1'].view.setValues(nearPlane=677.706, 
    farPlane=1112.64, width=428.488, height=206.919, cameraPosition=(857.851, 
    -623.924, 221.586), cameraUpVector=(-0.51912, 0.360002, 0.775186), 
    cameraTarget=(185.843, -255.677, -49.8825), viewOffsetX=112.142, 
    viewOffsetY=73.6577)
session.viewports['Viewport: 1'].view.setValues(nearPlane=691.78, 
    farPlane=1098.75, width=437.387, height=211.216, cameraPosition=(828.459, 
    -573.191, 379.427), cameraUpVector=(-0.621027, 0.440847, 0.648057), 
    cameraTarget=(194.753, -260.445, -22.4476), viewOffsetX=114.471, 
    viewOffsetY=75.1874)
session.viewports['Viewport: 1'].view.setValues(nearPlane=687.245, 
    farPlane=1095.53, width=434.52, height=209.831, cameraPosition=(685.158, 
    -703.66, 405.832), cameraUpVector=(-0.467878, 0.62672, 0.623148), 
    cameraTarget=(143.45, -262.418, -9.80603), viewOffsetX=113.721, 
    viewOffsetY=74.6945)
session.viewports['Viewport: 1'].view.setValues(nearPlane=705.279, 
    farPlane=1088.86, width=445.923, height=215.337, cameraPosition=(853.146, 
    -462.406, 458.737), cameraUpVector=(-0.655916, 0.500418, 0.565116), 
    cameraTarget=(206.349, -261.091, 9.2676), viewOffsetX=116.705, 
    viewOffsetY=76.6546)
session.viewports['Viewport: 1'].view.setValues(nearPlane=685.492, 
    farPlane=1108.43, width=433.413, height=209.296, cameraPosition=(882.78, 
    -537.731, 320.887), cameraUpVector=(-0.445211, 0.601666, 0.663163), 
    cameraTarget=(182.316, -264.692, 11.539), viewOffsetX=113.431, 
    viewOffsetY=74.5041)
session.viewports['Viewport: 1'].view.setValues(nearPlane=679.558, 
    farPlane=1113.1, width=429.661, height=207.484, cameraPosition=(874.144, 
    -586.275, 258.957), cameraUpVector=(-0.367286, 0.602552, 0.708542), 
    cameraTarget=(171.788, -265.529, 4.56585), viewOffsetX=112.449, 
    viewOffsetY=73.8592)
session.viewports['Viewport: 1'].view.setValues(nearPlane=679.867, 
    farPlane=1112.79, width=429.857, height=207.578, cameraPosition=(883.385, 
    -584.499, 235.683), cameraUpVector=(-0.432549, 0.495237, 0.75342), 
    cameraTarget=(181.029, -263.753, -18.7077), viewOffsetX=112.5, 
    viewOffsetY=73.8928)
session.viewports['Viewport: 1'].view.setValues(nearPlane=682.255, 
    farPlane=1104.31, width=431.367, height=208.307, cameraPosition=(776.741, 
    -663.154, 332.896), cameraUpVector=(-0.490168, 0.535072, 0.688064), 
    cameraTarget=(163.044, -264.143, -20.7467), viewOffsetX=112.895, 
    viewOffsetY=74.1524)
session.viewports['Viewport: 1'].view.setValues(nearPlane=700.087, 
    farPlane=1092.76, width=442.641, height=213.751, cameraPosition=(852.504, 
    -493.174, 431.072), cameraUpVector=(-0.622733, 0.5109, 0.592608), 
    cameraTarget=(199.981, -263.063, 4.27085), viewOffsetX=115.846, 
    viewOffsetY=76.0905)
session.viewports['Viewport: 1'].view.setValues(nearPlane=691.505, 
    farPlane=1087.72, width=437.215, height=211.131, cameraPosition=(600.815, 
    -745.549, 437.518), cameraUpVector=(-0.435678, 0.678039, 0.591986), 
    cameraTarget=(124.511, -261.629, -9.53115), viewOffsetX=114.426, 
    viewOffsetY=75.1577)
session.viewports['Viewport: 1'].view.setValues(nearPlane=678.979, 
    farPlane=1100.24, width=429.295, height=207.307, cameraPosition=(633.033, 
    -797.195, 298.076), cameraUpVector=(-0.383354, 0.580518, 0.718359), 
    cameraTarget=(122.82, -257.731, -32.9212), viewOffsetX=112.353, 
    viewOffsetY=73.7963)
mdb.save()
#: The model database has been saved to "Y:\mb_16_v2.cae".
